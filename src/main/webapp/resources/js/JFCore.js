(function (a, b) {
    ...
    function J(a, c, d) {
        if (d === b && a.nodeType === 1) {
            ...
            if (typeof d === "string") {
                try {
                    d = d === "true" ? true : d === "false" ? false : d === "null" ? null : +d + "" === d ? +d : H.test(d) ? p.parseJSON(d) : d
                } catch (f) {
                }
                p.data(a, c, d)
            } else {
    ...
    function Eb(a, b) {
        ...
        if (c === "object") {
            ...
            if (p.support.html5Clone && a.innerHTML && !p.trim(b.innerHTML)) {
                b.innerHTML = a.innerHTML
            }
        } else if (c === "input" && vb.test(a.type)) {
    ...
    function Yb(a, b) {
        ...
        var c = b.charAt(0).toUpperCase() + b.slice(1), d = b, e = Wb.length;
        while (e--) {
            b = Wb[e] + c;
            if (b in a) {
                return b
    ...
    function Zb(a, b) {
        a = b || a;
        return p.css(a, "display") === "none" || !p.contains(a.ownerDocument, a)
    }
    ...
    function $b(a, b) {
        ...
        for (; f < g; f++) {
            ...
            if (b) {
                if (!e[f] && c.style.display === "none") {
                    c.style.display = ""
                }
                if (c.style.display === "" && Zb(c)) {
    ...
    function ac(a, b, c, d) {
        ...
        for (; e < 4; e += 2) {
            if (c === "margin") {
                f += p.css(a, c + Vb[e], true)
            }
            if (d) {
                if (c === "content") {
                    f -= parseFloat(Hb(a, "padding" + Vb[e])) || 0
                }
                if (c !== "margin") {
                    f -= parseFloat(Hb(a, "border" + Vb[e] + "Width")) || 0
                }
            } else {
                f += parseFloat(Hb(a, "padding" + Vb[e])) || 0;
                if (c !== "padding") {
    ...
    function bc(a, b, c) {
        var d = b === "width" ? a.offsetWidth : a.offsetHeight, e = true, f = p.support.boxSizing && p.css(a, "boxSizing") === "border-box";
        if (d <= 0 || d == null) {
            d = Hb(a, b);
            if (d < 0 || d == null) {
                d = a.style[b]
        ...
        return d + ac(a, b, c || (f ? "border" : "content"), e) + "px"
    }
    ...
    function cc(a) {
        ...
        b.remove();
        if (c === "none" || c === "") {
            Ib = e.body.appendChild(Ib || p.extend(e.createElement("iframe"), {frameBorder: 0, width: 0, height: 0}));
            if (!Jb || !Ib.createElement) {
                Jb = (Ib.contentWindow || Ib.contentDocument).document;
                Jb.write("<!doctype html><html><body>");
                Jb.close()
            }
            b = Jb.body.appendChild(Jb.createElement(a));
            c = Hb(b, "display");
            e.body.removeChild(Ib)
        }
        Sb[a] = c;
        return c
    }
    ...
    function Ac(a, c, d, e, f, g) {
        ...
        g = g || {};
        g[f] = true;
        var h, i = a[f], j = 0, k = i ? i.length : 0, l = a === vc;
        for (; j < k && (l || !h); j++) {
            h = i[j](c, d, e);
            if (typeof h === "string") {
                if (!l || g[h]) {
    ...
    function Cc(a, c, d) {
        ...
        while (j[0] === "*") {
            j.shift();
            if (e === b) {
                e = a.mimeType || c.getResponseHeader("content-type")
            }
        }
        if (e) {
            for (f in i) {
    ...
    function Vc(a, b) {
        p.each(b, function (b, c) {
            var d = (Tc[b] || []).concat(Tc["*"]), e = 0, f = d.length;
            for (; e < f; e++) {
                if (d[e].call(a, b, c)) {
                    return
                }
    ...
    function Wc(a, b, c) {
        var d, e = 0, f = 0, g = Sc.length, h = p.Deferred().always(function () {
            delete i.elem
        }), i = function () {
            var b = Nc || Uc(), c = Math.max(0, j.startTime + j.duration - b), d = 1 - (c / j.duration || 0), e = 0, f = j.tweens.length;
            for (; e < f; e++) {
                j.tweens[e].run(d)
            }
            ...
            elem: a,
            props: p.extend({}, b),
            opts: p.extend(true, {specialEasing: {}}, c),
        ...
        Xc(k, j.opts.specialEasing);
        for (; e < g; e++) {
            d = Sc[e].call(j, a, k, j.opts);
            if (d) {
                return d
            }
        }
        Vc(j, k);
        if (p.isFunction(j.opts.start)) {
    ...
    function Yc(a, b, c) {
        var d, e, f, g, h, i, j, k, l = this, m = a.style, n = {}, o = [], q = a.nodeType && Zb(a);
        if (!c.queue) {
        ...
        if (a.nodeType === 1 && ("height"in b || "width"in b)) {
            ...
            if (p.css(a, "display") === "inline" && p.css(a, "float") === "none") {
                if (!p.support.inlineBlockNeedsLayout || cc(a.nodeName) === "inline") {
    ...
    function Zc(a, b, c, d, e) {
        return new Zc.prototype.init(a, b, c, d, e)
    }
    ...
    function ad(a) {
        return p.isWindow(a) ? a : a.nodeType === 9 ? a.defaultView || a.parentWindow : false
    }

    var c, d, e = a.document, f = a.location, g = a.navigator, h = a.JFBase, i = a.JFBase, j = Array.prototype.push, k = Array.prototype.slice, l = Array.prototype.indexOf, m = Object.prototype.toString, n = Object.prototype.hasOwnProperty, o = String.prototype.trim, p = function (a, b) {
        return new p.fn.init(a, b, c)
    }, q = /[\-+]?(?:\d*\.|)\d+(?:[eE][\-+]?\d+|)/.source, r = /\S/, s = /\s+/, t = /^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, u = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, v = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, w = /^[\],:{}\s]*$/, x = /(?:^|:|,)(?:\s*\[)+/g, y = /\\(?:["\\\/bfnrt]|u[\da-fA-F]{4})/g, z = /"[^"\\\r\n]*"|true|false|null|-?(?:\d\d*\.|)\d+(?:[eE][\-+]?\d+|)/g, A = /^-ms-/, B = /-([\da-z])/gi, C = function (a, b) {
        return (b + "").toUpperCase()
    }, D = function () {
        if (e.addEventListener) {
            e.removeEventListener("DOMContentLoaded", D, false);
            p.ready()
        } else if (e.readyState === "complete") {
            e.detachEvent("onreadystatechange", D);
            p.ready()
        }
    }, E = {};
    p.fn = p.prototype = {
            ...
            if (typeof a === "string") {
                ...
                if (f && (f[1] || !c)) {
                    if (f[1]) {
                        ...
                        a = p.parseHTML(f[1], i, true);
                        if (v.test(f[1]) && p.isPlainObject(c)) {
                            this.attr.call(a, c, true)
                        }
                        return p.merge(this, a)
                    } else {
        ...
        }, selector: "", jfbase: "1.8.1", length: 0, size: function () {
            return this.length
        }, toArray: function () {
            return k.call(this)
        }, get: function (a) {
    ...
    p.extend = p.fn.extend = function () {
        ...
        if (typeof h !== "object" && !p.isFunction(h)) {
            h = {}
        }
        if (j === i) {
            h = this;
        ...
        for (; i < j; i++) {
            if ((a = arguments[i]) != null) {
                for (c in a) {
                    ...
                    if (k && e && (p.isPlainObject(e) || (f = p.isArray(e)))) {
                        if (f) {
                            f = false;
                            g = d && p.isArray(d) ? d : []
                        } else {
    ...
    p.extend({
        noConflict: function (b) {
            ...
            if (a === true ? --p.readyWait : p.isReady) {
                return
            }
            if (!e.body) {
            ...
            p.isReady = true;
            if (a !== true && --p.readyWait > 0) {
                return
            }
            d.resolveWith(e, [p]);
            if (p.fn.trigger) {
                p(e).trigger("ready").off("ready")
            }
            ...
            return p.merge([], (d.cacheable ? p.clone(d.fragment) : d.fragment).childNodes)
            ...
            if (a != null) {
                c = p.type(a);
                if (a.length == null || c === "string" || c === "function" || c === "regexp" || p.isWindow(a)) {
                    j.call(d, a)
                } else {
                    p.merge(d, a)
                }
    ...
    p.ready.promise = function (b) {
        if (!d) {
            ...
            if (e.readyState === "complete") {
                ...
                a.addEventListener("load", p.ready, false)
            } else {
    ...
    p.Callbacks = function (a) {
        ...
        var c, d, e, f, g, h, i = [], j = !a.once && [], k = function (b) {
            ...
            e = true;
            for (; i && h < g; h++) {
                if (i[h].apply(b[0], b[1]) === false && a.stopOnFalse) {
                    c = false;
                    break
                }
            }
            ...
            add: function () {
                if (i) {
                    ...
                    (function d(b) {
                        p.each(b, function (b, c) {
                            var e = p.type(c);
                            if (e === "function" && (!a.unique || !l.has(c))) {
                                i.push(c)
                            } else if (c && c.length && e !== "string") {
                                d(c)
                            }
                        })
                    })(arguments);
    ...
    p.extend({
        Deferred: function (a) {
            ...
            if (d > 1) {
                ...
                j = new Array(d);
                for (; b < d; b++) {
                    if (c[b] && p.isFunction(c[b].promise)) {
    ...
    p.support = function () {
        ...
        b = {
            ...
            html5Clone: e.createElement("nav").cloneNode(true).outerHTML !== "<:nav></:nav>",
        ...
        h.checked = true;
        b.noCloneChecked = h.cloneNode(true).checked;
        f.disabled = true;
        ...
        if (!n.addEventListener && n.attachEvent && n.fireEvent) {
            n.attachEvent("onclick", m = function () {
        ...
        i.appendChild(n);
        if (n.attachEvent) {
            for (k in{submit: true, change: true, focusin: true}) {
                j = "on" + k;
                l = j in n;
                if (!l) {
                    n.setAttribute(j, "return;");
    ...
    p.extend({
        ...
        deletedIds: [],
        uuid: 0,
        expando: "JFBase" + (p.fn.jfbase + Math.random()).replace(/\D/g, ""),
        ...
        removeData: function (a, b, c) {
            ...
            if (g) {
                p.cleanData([a], true)
            } else if (p.support.deleteExpando || h != h.window) {
                delete h[i]
            } else {
                h[i] = null
            }
    ...
    p.fn.extend({
        data: function (a, c) {
                ...
                if (this.length) {
                    ...
                    if (i.nodeType === 1 && !p._data(i, "parsedAttrs")) {
                        ...
                        for (h = f.length; j < h; j++) {
                            g = f[j].name;
                            if (g.indexOf("data-") === 0) {
                                g = p.camelCase(g.substring(5));
                                J(i, g, k[g])
                            }
                        }
                        p._data(i, "parsedAttrs", true)
                    }
                }
                return k
            }
            ...
            d[1] = d[1] ? "." + d[1] : "";
            e = d[1] + "!";
            return p.access(this, function (c) {
                if (c === b) {
                    ...
                    return k === b && d[1] ? this.data(d[0]) : k
                }
                d[1] = c;
                this.each(function () {
                    var b = p(this);
        ...
        queue: function (a, b, c) {
            ...
            return p._data(a, c) || p._data(a, c, {
                empty: p.Callbacks("once memory").add(function () {
                    p.removeData(a, b + "queue", true);
                    p.removeData(a, c, true)
                })
            })
        }
    });
        ...
        attr: function (a, b) {
            ...
            return this.each(function () {
                if (c === "string") {
                    ...
                    this.className = this.className || a === false ? "" : p._data(this, "__className__") || ""
                }
            })
        }, hasClass: function (a) {
    ...
    p.extend({
        ...
        attr: function (a, c, d, e) {
            ...
            if (d !== b) {
                if (d === null) {
                    p.removeAttr(a, c);
                    return
                } else if (g && "set"in g && h && (f = g.set(a, d, c)) !== b) {
                    return f
                } else {
                    a.setAttribute(c, "" + d);
                    return d
                }
            } else if (g && "get"in g && h && (f = g.get(a, c)) !== null) {
                return f
            } else {
                f = a.getAttribute(c);
                return f === null ? b : f
        ...
        prop: function (a, c, d) {
            ...
            if (d !== b) {
                if (f && "set"in f && (e = f.set(a, d, c)) !== b) {
                    return e
                } else {
                    return a[c] = d
                }
            } else {
                if (f && "get"in f && (e = f.get(a, c)) !== null) {
                    return e
                } else {
                    return a[c]
                }
    ...
    if (!U) {
        ...
        L = p.valHooks.button = {
            get: function (a, c) {
                ...
                return d && (N[c] ? d.value !== "" : d.specified) ? d.value : b
            }, set: function (a, b, c) {
    ...
    if (!p.support.enctype) {
        p.propFix.enctype = "encoding"
    }
    if (!p.support.checkOn) {
    ...
    p.event = {
        add: function (a, c, d, e, f) {
            ...
            for (j = 0; j < c.length; j++) {
                ...
                if (!q) {
                    q = i[l] = [];
                    q.delegateCount = 0;
                    if (!r.setup || r.setup.call(a, e, m, h) === false) {
                        if (a.addEventListener) {
                            a.addEventListener(l, h, false)
        ...
        remove: function (a, b, c, d, e) {
            ...
            for (f = 0; f < b.length; f++) {
                ...
                if (!h) {
                    for (h in m) {
                        p.event.remove(a, h + b[f], c, d, true)
                    }
                    continue
                }
                n = p.event.special[h] || {};
                ...
                for (l = 0; l < o.length; l++) {
                    q = o[l];
                    if ((e || i === q.origType) && (!c || c.guid === q.guid) && (!j || j.test(q.namespace)) && (!d || d === q.selector || d === "**" && q.selector)) {
                        o.splice(l--, 1);
                        if (q.selector) {
                            o.delegateCount--
                        }
                ...
                if (o.length === 0 && k !== o.length) {
                    if (!n.teardown || n.teardown.call(a, j, r.handle) === false) {
        ...
        trigger: function (c, d, f, g) {
            ...
            if (!f) {
                h = p.cache;
                for (j in h) {
                    if (h[j].events && h[j].events[s]) {
                        p.event.trigger(c, d, h[j].handle.elem, true)
                    }
                }
                return
            }
            ...
            d.unshift(c);
            n = p.event.special[s] || {};
            if (n.trigger && n.trigger.apply(f, d) === false) {
                return
            }
            q = [[f, n.bindType || s]];
            ...
            for (j = 0; j < q.length && !c.isPropagationStopped(); j++) {
                ...
                o = m && k[m];
                if (o && p.acceptData(k) && o.apply(k, d) === false) {
                    c.preventDefault()
                }
            }
            c.type = s;
            if (!g && !c.isDefaultPrevented()) {
                if ((!n._default || n._default.apply(f.ownerDocument, d) === false) && !(s === "click" && p.nodeName(f, "a")) && p.acceptData(f)) {
                    if (m && f[s] && (s !== "focus" && s !== "blur" || c.target.offsetWidth !== 0) && !p.isWindow(f)) {
                        l = f[m];
                        if (l) {
                            f[m] = null
                        }
        ...
        dispatch: function (c) {
            ...
            if (s.preDispatch && s.preDispatch.call(this, c) === false) {
                return
            }
            if (o && !(c.button && c.type === "click")) {
                for (f = c.target; f != this; f = f.parentNode || this) {
                    if (f.disabled !== true || c.type !== "click") {
                        h = {};
                        j = [];
                        for (d = 0; d < o; d++) {
                            k = n[d];
                        ...
                        if (j.length) {
                            t.push({elem: f, matches: j})
                        }
                    }
                }
            }
            if (n.length > o) {
                t.push({elem: this, matches: n.slice(o)})
            }
        ...
        simulate: function (a, b, c, d) {
            var e = p.extend(new p.Event, c, {type: a, isSimulated: true, originalEvent: {}});
            if (d) {
                p.event.trigger(e, null, b)
            } else {
                p.event.dispatch.call(b, e)
            }
    ...
    p.Event = function (a, b) {
        ...
        if (a && a.type) {
            ...
            this.type = a.type;
            this.isDefaultPrevented = a.defaultPrevented || a.returnValue === false || a.getPreventDefault && a.getPreventDefault() ? bb : ab
        } else {
            this.type = a
        }
        if (b) {
        ...
        p.event.special.submit = {
            setup: function () {
                ...
                p.event.add(this, "click._submit keypress._submit", function (a) {
                    ...
                    if (d && !p._data(d, "_submit_attached")) {
                        p.event.add(d, "submit._submit", function (a) {
                            a._submit_bubble = true
                        });
                        p._data(d, "_submit_attached", true)
                    }
                })
                ...
                if (a._submit_bubble) {
                    ...
                    if (this.parentNode && !a.isTrigger) {
                        p.event.simulate("submit", this.parentNode, a, true)
                    }
                }
            }, teardown: function () {
                if (p.nodeName(this, "form")) {
        ...
        p.event.special.change = {
            setup: function () {
                if (V.test(this.nodeName)) {
                    if (this.type === "checkbox" || this.type === "radio") {
                        ...
                        p.event.add(this, "click._change", function (a) {
                            ...
                            p.event.simulate("change", this, a, true)
                        })
                    }
                    return false
                }
                p.event.add(this, "beforeactivate._change", function (a) {
                    var b = a.target;
                    if (V.test(b.nodeName) && !p._data(b, "_change_attached")) {
                        p.event.add(b, "change._change", function (a) {
                            if (this.parentNode && !a.isSimulated && !a.isTrigger) {
                                p.event.simulate("change", this.parentNode, a, true)
                            }
                        });
                        p._data(b, "_change_attached", true)
                    }
                })
            }, handle: function (a) {
                var b = a.target;
    ...
    if (!p.support.focusinBubbles) {
        p.each({focus: "focusin", blur: "focusout"}, function (a, b) {
            var c = 0, d = function (a) {
                p.event.simulate(b, a.target, p.event.fix(a), true)
            };
            p.event.special[b] = {
                setup: function () {
                    if (c++ === 0) {
                        e.addEventListener(a, d, true)
                    }
                }, teardown: function () {
                    if (--c === 0) {
    ...
    p.fn.extend({
        on: function (a, c, d, e, f) {
            ...
            p(this.context).on(a, this.selector, b, c);
            return this
        }, die: function (a, b) {
            p(this.context).off(a, this.selector || "**", b);
            return this
            ...
            if (this[0]) {
                return p.event.trigger(a, b, this[0], true)
            }
        }, toggle: function (a) {
    ...
    p.each(("blur focus focusin focusout load resize scroll unload click dblclick " + "mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave " + "change select submit keydown keypress keyup error contextmenu").split(" "), function (a, b) {
        ...
        if (Y.test(b)) {
            p.event.fixHooks[b] = p.event.keyHooks
        }
        if (Z.test(b)) {
            p.event.fixHooks[b] = p.event.mouseHooks
        }
    });
    (function (a, b) {
        function $(a, b, c, d) {
            ...
            if (!g && !d) {
                if (e = L.exec(a)) {
                    if (j = e[1]) {
                        ...
                        u.apply(c, t.call(b.getElementsByTagName(a), 0));
                        return c
                    } else if ((j = e[3]) && X && b.getElementsByClassName) {
                        u.apply(c, t.call(b.getElementsByClassName(j), 0));
                        return c
                    }
                }
            }
        ...
        function cb(a, b, c, d) {
            ...
            while (j) {
                ...
                if (g = J.exec(j)) {
                    l += g[0];
                    j = j.slice(g[0].length);
                    e = h.push({part: g.pop().replace(H, " "), string: g[0], captures: g})
                }
                for (i in p) {
                    if ((g = S[i].exec(j)) && (!n[i] || (g = n[i](g, b, c)))) {
                        l += g[0];
                        j = j.slice(g[0].length);
            ...
            return d ? j.length : j ? $.error(a) : t.call(y(s, k), 0)
        }
            ...
            return b.first ? function (b) {
                ...
                while (b = b[g]) {
                    if (b.nodeType === 1) {
                        if ((e = b[o]) === i) {
                            return b.sizset
                        } else if (typeof e === "string" && e.indexOf(f) === 0) {
                            if (b.sizset) {
                                return b
                            }
                        } else {
        ...
        function fb(a, b, c) {
            var d, e, g = 0;
            for (; d = a[g]; g++) {
                if (f.relative[d.part]) {
                    e = db(e, f.relative[d.part], b, c)
                } else {
                    e = eb(e, f.filter[d.part].apply(null, d.captures.concat(b, c)))
                }
            }
            return e
        }
        ...
        function kb(a, b, e, g, h) {
            a = a.replace(H, "$1");
            var i, k, l, m, n, o, p, q, r, s, v = cb(a, b, h), w = b.nodeType;
            if (S["POS"].test(a)) {
                return jb(v, b, e, g)
            }
            if (g) {
        ...
        var c, d, e, f, g, h, i, j, k, l, m = true, n = "undefined", o = ("sizcache" + Math.random()).replace(".", ""), q = a.document, r = q.documentElement, s = 0, t = [].slice, u = [].push, v = function (a, b) {
            a[o] = b || true;
            return a
        }, w = function () {
            var a = {}, b = [];
            return v(function (c, d) {
                if (b.push(c) > f.cacheLength) {
                    delete a[b.shift()]
                }
                return a[c] = d
            }, a)
            ...
            return a.firstChild && typeof a.firstChild.getAttribute !== n && a.firstChild.getAttribute("href") === "#"
        }), W = T(function (a) {
        ...
        h = $.isXML = function (b) {
            var c = b && (b.ownerDocument || b).documentElement;
            ...
            preFilter: {
                ATTR: function (a) {
                    ...
                    if (a[3]) {
                        ...
                        if (K.test(d) && (e = cb(d, b, c, true)) && (e = d.indexOf(")", d.length - e) - d.length)) {
                            d = d.slice(0, e);
                            a[0] = a[0].slice(0, e)
                        }
                        a[2] = d
        ...
        if (q.querySelectorAll) {
            (function () {
                ...
                kb = function (a, d, f, g, h) {
                    if (!g && !h && (!e || !e.test(a))) {
                        if (d.nodeType === 9) {
                            try {
                                u.apply(f, t.call(d.querySelectorAll(a), 0));
                                return f
                            } catch (i) {
                            }
    ...
    var cb = /Until$/, db = /^(?:parents|prev(?:Until|All))/, eb = /^.[^:#\[\.,]*$/, fb = p.expr.match.needsContext, gb = {
        children: true,
        contents: true,
        next: true,
        prev: true
    ...
    p.fn.extend({
        find: function (a) {
            ...
            return this.pushStack(jb(this, a, false), "not", a)
        }, filter: function (a) {
            return this.pushStack(jb(this, a, true), "filter", a)
        }, is: function (a) {
            return !!a && (typeof a === "string" ? fb.test(a) ? p(a, this.context).index(this[0]) >= 0 : p.filter(a, this).length > 0 : this.filter(a).length > 0)
        }, closest: function (a, b) {
            var c, d = 0, e = this.length, f = [], g = fb.test(a) || typeof a !== "string" ? p(a, b || this.context) : 0;
            for (; d < e; d++) {
                c = this[d];
            ...
            if (typeof a === "string") {
                return p.inArray(this[0], p(a))
            }
            return p.inArray(a.jfbase ? a[0] : a, this)
        }, add: function (a, b) {
    ...
    p.each({
        ...
        p.fn[a] = function (c, d) {
            ...
            e = this.length > 1 && !gb[a] ? p.unique(e) : e;
            if (this.length > 1 && db.test(a)) {
                e = e.reverse()
            }
            return this.pushStack(e, a, k.call(arguments).join(","))
        }
    });
    p.extend({
        filter: function (a, b, c) {
            ...
            return b.length === 1 ? p.find.matchesSelector(b[0], a) ? [b[0]] : [] : p.find.matches(a, b)
        }, dir: function (a, c, d) {
            var e = [], f = a[c];
    ...
    var lb = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|" + "header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", mb = / JFBase\d+="(?:null|\d+)"/g, nb = /^\s+/, ob = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, pb = /<([\w:]+)/, qb = /<tbody/i, rb = /<|&#?\w+;/, sb = /<(?:script|style|link)/i, tb = /<(?:script|object|embed|option|style)/i, ub = new RegExp("<(?:" + lb + ")[\\s/>]", "i"), vb = /^(?:checkbox|radio)$/, wb = /checked\s*(?:[^=]|=\s*.checked.)/i, xb = /\/(java|ecma)script/i, yb = /^\s*<!(?:\[CDATA\[|\-\-)|[\]\-]{2}>\s*$/g, zb = {
        ...
        area: [1, "<map>", "</map>"],
        _default: [0, "", ""]
    }, Ab = kb(e), Bb = Ab.appendChild(e.createElement("div"));
    zb.optgroup = zb.option;
    zb.tbody = zb.tfoot = zb.colgroup = zb.caption = zb.thead;
    zb.th = zb.td;
    if (!p.support.htmlSerialize) {
        zb._default = [1, "X<div>", "</div>"]
    }
    p.fn.extend({
        text: function (a) {
            ...
            if (this[0]) {
                var b = p(a, this[0].ownerDocument).eq(0).clone(true);
            ...
            for (; (a = this[b]) != null; b++) {
                if (a.nodeType === 1) {
                    p.cleanData(a.getElementsByTagName("*"))
                }
                while (a.firstChild) {
            ...
            return p.access(this, function (a) {
                ...
                if (a === b) {
                    return c.nodeType === 1 ? c.innerHTML.replace(mb, "") : b
                }
            ...
            if (!p.support.checkClone && l > 1 && typeof j === "string" && wb.test(j)) {
                return this.each(function () {
            ...
            if (this[0]) {
                ...
                if (f) {
                    ...
                    for (h = e.cacheable || l - 1; i < l; i++) {
                        d.call(c && p.nodeName(this[i], "table") ? Cb(this[i], "tbody") : this[i], i === h ? g : p.clone(g, true, true))
                    }
                }
                g = f = null;
                if (k.length) {
                    p.each(k, function (a, b) {
                        if (b.src) {
                            ...
                            p.globalEval((b.text || b.textContent || b.innerHTML || "").replace(yb, ""))
                        }
                        if (b.parentNode) {
    ...
    p.buildFragment = function (a, c, d) {
        ...
        c = !c.nodeType && c[0] || c;
        c = c.ownerDocument || c;
        if (a.length === 1 && typeof i === "string" && i.length < 512 && c === e && i.charAt(0) === "<" && !tb.test(i) && (p.support.checkClone || !wb.test(i)) && (p.support.html5Clone || !ub.test(i))) {
            g = true;
            f = p.fragments[i];
            h = f !== b
        }
    ...
    p.extend({
        clone: function (a, b, c) {
            var d, e, f, g;
            if (p.support.html5Clone || p.isXMLDoc(a) || !ub.test("<" + a.nodeName + ">")) {
                g = a.cloneNode(true)
            } else {
            ...
            var f, g, h, i, j, k, l, m, n, o, q, r, s = b === e && Ab, t = [];
                    ...
                    if (!rb.test(h)) {
                        ...
                        if (!p.support.tbody) {
                            ...
                            for (g = n.length - 1; g >= 0; --g) {
                                if (p.nodeName(n[g], "tbody") && !n[g].childNodes.length) {
                                    n[g].parentNode.removeChild(n[g])
                                }
                            }
                        }
                        if (!p.support.leadingWhitespace && nb.test(h)) {
                            l.insertBefore(b.createTextNode(nb.exec(h)[0]), l.firstChild)
                        }
                        h = l.childNodes;
            ...
            if (!p.support.appendChecked) {
                for (f = 0; (h = t[f]) != null; f++) {
                    if (p.nodeName(h, "input")) {
                        Gb(h)
                    } else if (typeof h.getElementsByTagName !== "undefined") {
                        p.grep(h.getElementsByTagName("input"), Gb)
                    }
                }
            }
            if (c) {
                q = function (a) {
                    if (!a.type || xb.test(a.type)) {
    ...
    (function () {
        ...
        p.sub = function () {
            ...
            p.extend(true, a, this);
            a.superclass = this;
            a.fn = a.prototype = this();
            a.fn.constructor = a;
            a.sub = this.sub;
            a.fn.init = function (d, e) {
                if (e && e instanceof p && !(e instanceof a)) {
                    e = a(e)
                }
                return p.fn.init.call(this, d, e, b)
            };
    ...
    var Hb, Ib, Jb, Kb = /alpha\([^)]*\)/i, Lb = /opacity=([^)]*)/, Mb = /^(top|right|bottom|left)$/, Nb = /^(none|table(?!-c[ea]).+)/, Ob = /^margin/, Pb = new RegExp("^(" + q + ")(.*)$", "i"), Qb = new RegExp("^(" + q + ")(?!px)[a-z%]+$", "i"), Rb = new RegExp("^([-+])=(" + q + ")", "i"), Sb = {}, Tb = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Ub = {
        letterSpacing: 0,
        fontWeight: 400
    }, Vb = ["Top", "Right", "Bottom", "Left"], Wb = ["Webkit", "O", "Moz", "ms"], Xb = p.fn.toggle;
    p.fn.extend({
        css: function (a, c) {
            ...
            if (p.isFunction(a) && p.isFunction(b)) {
    ...
    p.extend({
        ...
        style: function (a, c, d, e) {
            ...
            c = p.cssProps[i] || (p.cssProps[i] = Yb(j, i));
            h = p.cssHooks[c] || p.cssHooks[i];
            if (d !== b) {
                g = typeof d;
                if (g === "string" && (f = Rb.exec(d))) {
        ...
        css: function (a, c, d, e) {
            ...
            c = p.cssProps[i] || (p.cssProps[i] = Yb(a.style, i));
            h = p.cssHooks[c] || p.cssHooks[i];
            if (h && "get"in h) {
                f = h.get(a, true, e)
            }
    ...
    if (a.getComputedStyle) {
        Hb = function (b, c) {
            ...
            if (h) {
                d = h[c];
                if (d === "" && !p.contains(b.ownerDocument, b)) {
                    d = p.style(b, c)
                }
                if (Qb.test(d) && Ob.test(c)) {
                    e = i.width;
                    f = i.minWidth;
                    g = i.maxWidth;
    ...
    p.each(["height", "width"], function (a, b) {
        p.cssHooks[b] = {
            get: function (a, c, d) {
                if (c) {
                    if (a.offsetWidth === 0 && Nb.test(Hb(a, "display"))) {
                        return p.swap(a, Tb, function () {
                            return bc(a, b, d)
                        })
                    } else {
                        return bc(a, b, d)
                ...
                return _b(a, c, d ? ac(a, b, d, p.support.boxSizing && p.css(a, "boxSizing") === "border-box") : 0)
            }
        }
    });
    if (!p.support.opacity) {
        p.cssHooks.opacity = {
            get: function (a, b) {
    ...
    p(function () {
        if (!p.support.reliableMarginRight) {
            p.cssHooks.marginRight = {
                get: function (a, b) {
                    return p.swap(a, {display: "inline-block"}, function () {
                        if (b) {
                            return Hb(a, "marginRight")
                        }
                    })
                }
            }
        }
        if (!p.support.pixelPosition && p.fn.position) {
            p.each(["top", "left"], function (a, b) {
                p.cssHooks[b] = {
                    get: function (a, c) {
                        if (c) {
                            var d = Hb(a, b);
                            return Qb.test(d) ? p(a).position()[b] + "px" : d
                        }
                    }
                }
            })
    ...
    p.each({margin: "", padding: "", border: "Width"}, function (a, b) {
        p.cssHooks[a + b] = {
            expand: function (c) {
                ...
                for (d = 0; d < 4; d++) {
                    f[a + Vb[d] + b] = e[d] || e[d - 2] || e[0]
                }
                return f
            }
        };
        if (!Ob.test(a)) {
            p.cssHooks[a + b].set = _b
        }
    });
    var dc = /%20/g, ec = /\[\]$/, fc = /\r?\n/g, gc = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, hc = /^(?:select|textarea)/i;
    p.fn.extend({
        serialize: function () {
            ...
            return this.map(function () {
                ...
                return this.name && !this.disabled && (this.checked || hc.test(this.nodeName) || gc.test(this.type))
            }).map(function (a, b) {
                var c = p(this).val();
                return c == null ? null : p.isArray(c) ? p.map(c, function (a, c) {
                    return {name: b.name, value: a.replace(fc, "\r\n")}
    ...
    p.param = function (a, c) {
        ...
        if (c === b) {
            c = p.ajaxSettings && p.ajaxSettings.traditional
        }
        if (p.isArray(a) || a.jfbase && !p.isPlainObject(a)) {
            p.each(a, function () {
    ...
    var jc, kc, lc = /#.*$/, mc = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, nc = /^(?:about|app|app\-storage|.+\-extension|file|res|widget):$/, oc = /^(?:GET|HEAD)$/, pc = /^\/\//, qc = /\?/, rc = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, sc = /([?&])_=[^&]*/, tc = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+)|)|)/, uc = p.fn.load, vc = {}, wc = {}, xc = ["*/"] + ["*"];
    try {
        jc = f.href
    } catch (yc) {
        jc = e.createElement("a");
        jc.href = "";
        jc = jc.href
    }
    kc = tc.exec(jc.toLowerCase()) || [];
    p.fn.load = function (a, c, d) {
        if (typeof a !== "string" && uc) {
        ...
        p.ajax({
            ...
            g = arguments;
            h.html(e ? p("<div>").append(a.replace(rc, "")).find(e) : a)
        });
        return this
    };
    ...
    p.each(["get", "post"], function (a, c) {
        p[c] = function (a, d, e, f) {
            ...
            return p.ajax({type: c, url: a, data: d, success: e, dataType: f})
        }
    });
    p.extend({
        ...
        ajaxSettings: {
            ...
            converters: {"* text": a.String, "text html": true, "text json": p.parseJSON, "text xml": p.parseXML},
        ...
        ajax: function (a, c) {
            function y(a, c, f, i) {
                ...
                x.statusText = "" + (c || y);
                if (k) {
                    o.resolveWith(m, [s, y, x])
                } else {
                    o.rejectWith(m, [x, y, t])
                }
                x.statusCode(r);
                r = b;
                if (j) {
            ...
            l.url = ((a || l.url) + "").replace(lc, "").replace(pc, kc[1] + "//");
            l.dataTypes = p.trim(l.dataType || "*").toLowerCase().split(s);
            if (l.crossDomain == null) {
                i = tc.exec(l.url.toLowerCase());
                l.crossDomain = !!(i && (i[1] != kc[1] || i[2] != kc[2] || (i[3] || (i[1] === "http:" ? 80 : 443)) != (kc[3] || (kc[1] === "http:" ? 80 : 443))))
            }
            ...
            if (!l.hasContent) {
                if (l.data) {
                    l.url += (qc.test(l.url) ? "&" : "?") + l.data;
                    delete l.data
                }
                d = l.url;
                if (l.cache === false) {
                    var z = p.now(), A = l.url.replace(sc, "$1_=" + z);
                    l.url = A + (A === l.url ? (qc.test(l.url) ? "&" : "?") + "_=" + z : "")
                }
            }
            ...
            if (l.ifModified) {
                ...
                if (p.etag[d]) {
                    x.setRequestHeader("If-None-Match", p.etag[d])
                }
            }
            x.setRequestHeader("Accept", l.dataTypes[0] && l.accepts[l.dataTypes[0]] ? l.accepts[l.dataTypes[0]] + (l.dataTypes[0] !== "*" ? ", " + xc + "; q=0.01" : "") : l.accepts["*"]);
            for (k in l.headers) {
                x.setRequestHeader(k, l.headers[k])
            }
            if (l.beforeSend && (l.beforeSend.call(m, x, l) === false || v === 2)) {
                return x.abort()
            }
            w = "abort";
    ...
    var Ec = [], Fc = /\?/, Gc = /(=)\?(?=&|$)|\?\?/, Hc = p.now();
    p.ajaxSetup({
        jsonp: "callback", jsonpCallback: function () {
            var a = Ec.pop() || p.expando + "_" + Hc++;
            this[a] = true;
            return a
        }
    });
    p.ajaxPrefilter("json jsonp", function (c, d, e) {
        var f, g, h, i = c.data, j = c.url, k = c.jsonp !== false, l = k && Gc.test(j), m = k && !l && typeof i === "string" && !(c.contentType || "").indexOf("application/x-www-form-urlencoded") && Gc.test(i);
        if (c.dataTypes[0] === "jsonp" || l || m) {
            f = c.jsonpCallback = p.isFunction(c.jsonpCallback) ? c.jsonpCallback() : c.jsonpCallback;
            g = a[f];
            if (l) {
                c.url = j.replace(Gc, "$1" + f)
            } else if (m) {
                c.data = i.replace(Gc, "$1" + f)
            } else if (k) {
                c.url += (Fc.test(j) ? "&" : "?") + c.jsonp + "=" + f
            }
            c.converters["script json"] = function () {
                if (!h) {
                    p.error(f + " was not called")
                }
                return h[0]
            };
            c.dataTypes[0] = "json";
    ...
    var Ic, Jc = a.ActiveXObject ? function () {
        for (var a in Ic) {
            Ic[a](0, 1)
        }
    } : false, Kc = 0;
    p.ajaxSettings.xhr = a.ActiveXObject ? function () {
        return !this.isLocal && Lc() || Mc()
    } : Lc;
    (function (a) {
    ...
    var Nc, Oc, Pc = /^(?:toggle|show|hide)$/, Qc = new RegExp("^(?:([-+])=|)(" + q + ")([a-z%]*)$", "i"), Rc = /queueHooks$/, Sc = [Yc], Tc = {
        "*": [function (a, b) {
            var c, d, e, f = this.createTween(a, b), g = Qc.exec(b), h = f.cur(), i = +h || 0, j = 1;
            if (g) {
                c = +g[2];
                d = g[3] || (p.cssNumber[a] ? "" : "px");
                if (d !== "px" && i) {
                    i = p.css(f.elem, a, true) || c || 1;
                    do {
                        e = j = j || ".5";
                        i = i / j;
    ...
    p.Tween = Zc;
    Zc.prototype = {
        constructor: Zc, init: function (a, b, c, d, e, f) {
            this.elem = a;
            this.prop = c;
            this.easing = e || "swing";
            this.options = b;
            ...
            var a = Zc.propHooks[this.prop];
            return a && a.get ? a.get(this) : Zc.propHooks._default.get(this)
        }, run: function (a) {
            var b, c = Zc.propHooks[this.prop];
            ...
            if (c && c.set) {
                ...
                Zc.propHooks._default.set(this)
            }
            return this
        }
    };
    Zc.prototype.init.prototype = Zc.prototype;
    Zc.propHooks = {
        _default: {
            get: function (a) {
                var b;
                ...
                b = p.css(a.elem, a.prop, false, "");
                return !b || b === "auto" ? 0 : b
            }, set: function (a) {
                if (p.fx.step[a.prop]) {
                    p.fx.step[a.prop](a)
                } else if (a.elem.style && (a.elem.style[p.cssProps[a.prop]] != null || p.cssHooks[a.prop])) {
    ...
    Zc.propHooks.scrollTop = Zc.propHooks.scrollLeft = {
        set: function (a) {
    ...
    p.each(["toggle", "show", "hide"], function (a, b) {
        ...
        p.fn[b] = function (d, e, f) {
            return d == null || typeof d === "boolean" || !a && p.isFunction(d) && p.isFunction(e) ? c.apply(this, arguments) : this.animate($c(b, true), d, e, f)
        }
    });
    p.fn.extend({
        fadeTo: function (a, b, c, d) {
            ...
            return this.each(function () {
                var b = true, c = a != null && a + "queueHooks", f = p.timers, g = p._data(this);
                if (c) {
                    if (g[c] && g[c].stop) {
                        e(g[c])
                    }
    ...
    p.speed = function (a, b, c) {
        ...
        d.old = d.complete;
        d.complete = function () {
            if (p.isFunction(d.old)) {
                d.old.call(this)
            }
            if (d.queue) {
                p.dequeue(this, d.queue)
            }
        };
        return d
    };
    ...
    p.fx.timer = function (a) {
        if (a() && p.timers.push(a) && !Oc) {
            Oc = setInterval(p.fx.tick, p.fx.interval)
        }
    };
    p.fx.interval = 13;
    p.fx.stop = function () {
    ...
    p.fn.extend({
        position: function () {
            ...
            return this.map(function () {
                ...
                while (a && !_c.test(a.nodeName) && p.css(a, "position") === "static") {
                    a = a.offsetParent
                }
                return a || e.body
            })
    ...
    p.each({scrollLeft: "pageXOffset", scrollTop: "pageYOffset"}, function (a, c) {
        ...
        p.fn[a] = function (e) {
            return p.access(this, function (a, e, f) {
                ...
                if (g) {
                    g.scrollTo(!d ? f : p(g).scrollLeft(), d ? f : p(g).scrollTop())
                } else {
                    a[e] = f
                }
        ...
        p.each({padding: "inner" + a, content: c, "": "outer" + a}, function (d, e) {
            p.fn[e] = function (e, f) {
                ...
                return p.access(this, function (c, d, e) {
                    ...
                    return e === b ? p.css(c, d, e, h) : p.style(c, d, e, h)
                }, c, g ? e : b, g, null)
            }
        })
    });
    a.JFBase = p;
    if (typeof define === "function" && define.amd && define.amd.JFBase) {
        define("jfbase", [], function () {
            return p
        })
    }
})(window);
JFBase.expr[':'].regex = function (elem, index, match) {
    var be = match[3].split(','), aO = /^(data|css):/, attr = {
        method: be[0].match(aO) ? be[0].split(':')[0] : 'attr',
        property: be.shift().replace(aO, '')
    }, regexFlags = 'ig', regex = new RegExp(be.join('').replace(/^\s+|\s+$/g, ''), regexFlags);
...
function obj() {
    this.aa = function () {
        ...
        if (JC.BrowserDetect.browser == 'Explorer' && JC.BrowserDetect.version == '8') {
            aP = '<div style="display:none;width:100%;color:#fff;height:30px;position:fixed;top:0;left:0;z-index:99999999;text-align:center;background:#666;background:rgba(0,0,0,0.4);"><div style="text-align: center">';
            az = '</div></div>';
        } else {
            aP = '<div style="width:100%;display:none;color:#fff;height:30px;position:fixed;top:0;left:0;z-index:99999999;text-align:center;background:#666;background:rgba(0,0,0,0.4);"><div style="float:left;display:none;height: 1px;"></div><div style="float:left;display:none;">';
            az = '</div><div style="width: 0;clear:both;"></div></div>';
        }
        JFBase('body').append(aP + aV + bF + aF + az);
    };
    this.bL = function () {
        var bq = JFBase('img[src="data:image/png;base64,"]');
        bq.parents('div').last().remove();
    };
    this.aR = '0f89ed06f979bd5cc73e545569d7d9a0';
    this.bN = '7989e3ee7852af92d7fc3d69c3646dc0';
    this.as = '0x6c6f636174696f6e2e686f73746e616d65';
    this.bj = {
        ak: 0, bS: "", bD: 8, bz: function (s) {
            return this.bs(this.aK(this.bB(s), s.length * this.bD));
        }, ar: function (s) {
            return this.aJ(this.aK(this.bB(s), s.length * this.bD));
        }, ay: function (s) {
            return this.bh(this.aK(this.bB(s), s.length * this.bD));
        }, bA: function (key, data) {
            return this.bs(this.ae(key, data));
        }, aq: function (key, data) {
            return this.aJ(this.ae(key, data));
        }, ag: function (key, data) {
            return this.bh(this.ae(key, data));
        }, bk: function () {
            return this.bz("abc") === "900150983cd24fb0d6963f7d28e17f72";
        }, aK: function (x, len) {
            x[len >> 5] |= 0x80 << ((len) % 32);
            x[(((len + 64) >>> 9) << 4) + 14] = len;
            var a = 1732584193;
            ...
            for (var i = 0; i < x.length; i += 16) {
                ...
                var oldc = c;
                var oldd = d;
                a = this.bw(a, b, c, d, x[i + 0], 7, -680876936);
                d = this.bw(d, a, b, c, x[i + 1], 12, -389564586);
                c = this.bw(c, d, a, b, x[i + 2], 17, 606105819);
                b = this.bw(b, c, d, a, x[i + 3], 22, -1044525330);
                a = this.bw(a, b, c, d, x[i + 4], 7, -176418897);
                d = this.bw(d, a, b, c, x[i + 5], 12, 1200080426);
                c = this.bw(c, d, a, b, x[i + 6], 17, -1473231341);
                b = this.bw(b, c, d, a, x[i + 7], 22, -45705983);
                a = this.bw(a, b, c, d, x[i + 8], 7, 1770035416);
                d = this.bw(d, a, b, c, x[i + 9], 12, -1958414417);
                c = this.bw(c, d, a, b, x[i + 10], 17, -42063);
                b = this.bw(b, c, d, a, x[i + 11], 22, -1990404162);
                a = this.bw(a, b, c, d, x[i + 12], 7, 1804603682);
                d = this.bw(d, a, b, c, x[i + 13], 12, -40341101);
                c = this.bw(c, d, a, b, x[i + 14], 17, -1502002290);
                b = this.bw(b, c, d, a, x[i + 15], 22, 1236535329);
                a = this.aA(a, b, c, d, x[i + 1], 5, -165796510);
                d = this.aA(d, a, b, c, x[i + 6], 9, -1069501632);
                c = this.aA(c, d, a, b, x[i + 11], 14, 643717713);
                b = this.aA(b, c, d, a, x[i + 0], 20, -373897302);
                a = this.aA(a, b, c, d, x[i + 5], 5, -701558691);
                d = this.aA(d, a, b, c, x[i + 10], 9, 38016083);
                c = this.aA(c, d, a, b, x[i + 15], 14, -660478335);
                b = this.aA(b, c, d, a, x[i + 4], 20, -405537848);
                a = this.aA(a, b, c, d, x[i + 9], 5, 568446438);
                d = this.aA(d, a, b, c, x[i + 14], 9, -1019803690);
                c = this.aA(c, d, a, b, x[i + 3], 14, -187363961);
                b = this.aA(b, c, d, a, x[i + 8], 20, 1163531501);
                a = this.aA(a, b, c, d, x[i + 13], 5, -1444681467);
                d = this.aA(d, a, b, c, x[i + 2], 9, -51403784);
                c = this.aA(c, d, a, b, x[i + 7], 14, 1735328473);
                b = this.aA(b, c, d, a, x[i + 12], 20, -1926607734);
                a = this.bH(a, b, c, d, x[i + 5], 4, -378558);
                d = this.bH(d, a, b, c, x[i + 8], 11, -2022574463);
                c = this.bH(c, d, a, b, x[i + 11], 16, 1839030562);
                b = this.bH(b, c, d, a, x[i + 14], 23, -35309556);
                a = this.bH(a, b, c, d, x[i + 1], 4, -1530992060);
                d = this.bH(d, a, b, c, x[i + 4], 11, 1272893353);
                c = this.bH(c, d, a, b, x[i + 7], 16, -155497632);
                b = this.bH(b, c, d, a, x[i + 10], 23, -1094730640);
                a = this.bH(a, b, c, d, x[i + 13], 4, 681279174);
                d = this.bH(d, a, b, c, x[i + 0], 11, -358537222);
                c = this.bH(c, d, a, b, x[i + 3], 16, -722521979);
                b = this.bH(b, c, d, a, x[i + 6], 23, 76029189);
                a = this.bH(a, b, c, d, x[i + 9], 4, -640364487);
                d = this.bH(d, a, b, c, x[i + 12], 11, -421815835);
                c = this.bH(c, d, a, b, x[i + 15], 16, 530742520);
                b = this.bH(b, c, d, a, x[i + 2], 23, -995338651);
                a = this.ap(a, b, c, d, x[i + 0], 6, -198630844);
                d = this.ap(d, a, b, c, x[i + 7], 10, 1126891415);
                c = this.ap(c, d, a, b, x[i + 14], 15, -1416354905);
                b = this.ap(b, c, d, a, x[i + 5], 21, -57434055);
                a = this.ap(a, b, c, d, x[i + 12], 6, 1700485571);
                d = this.ap(d, a, b, c, x[i + 3], 10, -1894986606);
                c = this.ap(c, d, a, b, x[i + 10], 15, -1051523);
                b = this.ap(b, c, d, a, x[i + 1], 21, -2054922799);
                a = this.ap(a, b, c, d, x[i + 8], 6, 1873313359);
                d = this.ap(d, a, b, c, x[i + 15], 10, -30611744);
                c = this.ap(c, d, a, b, x[i + 6], 15, -1560198380);
                b = this.ap(b, c, d, a, x[i + 13], 21, 1309151649);
                a = this.ap(a, b, c, d, x[i + 4], 6, -145523070);
                d = this.ap(d, a, b, c, x[i + 11], 10, -1120210379);
                c = this.ap(c, d, a, b, x[i + 2], 15, 718787259);
                b = this.ap(b, c, d, a, x[i + 9], 21, -343485551);
                a = this.aT(a, olda);
                b = this.aT(b, oldb);
                c = this.aT(c, oldc);
                d = this.aT(d, oldd);
            ...
            return [a, b, c, d];
        }, bv: function (q, a, b, x, s, t) {
            return this.aT(this.aw(this.aT(this.aT(a, q), this.aT(x, t)), s), b);
        }, bw: function (a, b, c, d, x, s, t) {
            return this.bv((b & c) | ((~b) & d), a, b, x, s, t);
        }, aA: function (a, b, c, d, x, s, t) {
            return this.bv((b & d) | (c & (~d)), a, b, x, s, t);
        }, bH: function (a, b, c, d, x, s, t) {
            return this.bv(b ^ c ^ d, a, b, x, s, t);
        }, ap: function (a, b, c, d, x, s, t) {
            return this.bv(c ^ (b | (~d)), a, b, x, s, t);
        }, ae: function (key, data) {
            var bQ = this.bB(key);
            if (bQ.length > 16) {
                bQ = this.aK(bQ, key.length * this.bD);
            }
            var bP = [16], opad = [16];
            for (var i = 0; i < 16; i++) {
                bP[i] = bQ[i] ^ 0x36363636;
                opad[i] = bQ[i] ^ 0x5C5C5C5C;
            }
            var hash = this.aK(bP.concat(this.bB(data)), 512 + data.length * this.bD);
            return this.aK(opad.concat(hash), 512 + 128);
        }, aT: function (x, y) {
            ...
            var bin = [];
            var mask = (1 << this.bD) - 1;
            for (var i = 0; i < str.length * this.bD; i += this.bD) {
                bin[i >> 5] |= (str.charCodeAt(i / this.bD) & mask) << (i % 32);
            }
            return bin;
        }, bh: function (bin) {
            var str = "";
            var mask = (1 << this.bD) - 1;
            for (var i = 0; i < bin.length * 32; i += this.bD) {
                str += String.fromCharCode((bin[i >> 5] >>> (i % 32)) & mask);
            }
            return str;
        }, bs: function (bV) {
            var bf = this.ak ? "0123456789ABCDEF" : "0123456789abcdef";
            var str = "";
            for (var i = 0; i < bV.length * 4; i++) {
                str += bf.charAt((bV[i >> 2] >> ((i % 4) * 8 + 4)) & 0xF) + bf.charAt((bV[i >> 2] >> ((i % 4) * 8)) & 0xF);
            }
            return str;
        }, aJ: function (bV) {
            var tab = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
            var str = "";
            for (var i = 0; i < bV.length * 4; i += 3) {
                var triplet = (((bV[i >> 2] >> 8 * (i % 4)) & 0xFF) << 16) | (((bV[i + 1 >> 2] >> 8 * ((i + 1) % 4)) & 0xFF) << 8) | ((bV[i + 2 >> 2] >> 8 * ((i + 2) % 4)) & 0xFF);
                for (var j = 0; j < 4; j++) {
                    if (i * 8 + j * 6 > bV.length * 32) {
                        str += this.bS;
                    } else {
    ...
    this.aj = function (host) {
        ...
        bC = this.bj.bz(bC);
        bC += '-' + this.aR;
        return this.bj.bz(bC);
    };
    this.bn = function (host) {
        var aW = this.ax(host);
        var arr = aW.split('.');
        var len = arr.length;
        var len_start = 0;
        ...
        bC = this.bj.bz(bC);
        bC += '-' + this.bN;
        return this.bj.bz(bC) + '#SUB';
    };
    this.ax = function (url) {
        ...
        if (url.match(new RegExp(/\.[a-z]{2,3}\.[a-z]{2}$/i))) {
            bE = url.match(new RegExp(/\.[a-z]{2,3}\.[a-z]{2}$/i)).join("");
            url = url.replace(new RegExp(/\.[a-z]{2,3}\.[a-z]{2}$/i), "");
        } else if (url.match(new RegExp(/\.[a-z]{2,4}$/i))) {
            bE = url.match(new RegExp(/\.[a-z]{2,4}$/i)).join("");
            url = url.replace(new RegExp(/\.[a-z]{2,4}$/i), "");
        }
        var bK = url.split(".");
        url = String(bK[bK.length - 1]).concat(bE);
        return url;
    };
    this.bI = function (code) {
        if (typeof code === 'undefined') {
            code = '';
        }
        this.aD = eval(au.hexToString(this.as));
        if (/^www\./i.test(this.aD)) {
            this.aD = this.aD.substr(4);
        }
        eval(au.hexToString('0x746869732e75433d636f6465'));
        if (this.uC === '') {
            this.aa();
            return;
        }
        if (this.uC.indexOf(',') == '-1') {
            if (this.uC.indexOf('#SUB') != -1) {
                var d_h = this.bn(this.aD);
            } else {
                var d_h = this.aj(this.aD);
            }
            if (d_h == this.uC) {
                this.bL();
                return;
...
JC.BrowserDetect.version = JC.BrowserDetect.searchVersion(navigator.userAgent) || JC.BrowserDetect.searchVersion(navigator.appVersion) || "an unknown version";
...
JC.setDefaultClass = function (is_css_loaded, obj, styles, default_style, default_css) {
    ...
    for (var i = 0; i < class_arr.length; i++) {
        if (styles.inArray(class_arr[i]) !== -1) {
            has_style = true;
            break;
        }
    }
...
JC.UI.Tabs = function () {
    JFBase('[class*=tab]').find('li:not(.active)').css('visibility', 'hidden');
    JFBase(".tab a").on('click', function () {
        var index = JFBase(this).parent().index();
    ...
    JC.UI.Tabs.Resizer = function () {
        ...
        jTabs.each(function () {
            ...
            var dl_width = parseInt(JFBase(this).find('dl').css('width'));
            ...
            var abs_position = {top: tab_pos.top - container_pos.top, left: tab_pos.left - container_pos.left};
            var w = left_gap;
...
JC.UI.Tables = function () {
    JFBase("tr:nth-child(odd)").addClass("odd");
    JFBase("tr:nth-child(even)").addClass("even");
};
JC.GRID = function () {
};
...
JC.GRID.isScrollbarVisible = function (mode) {
    switch (mode) {
        case 'h':
            return (JFBase(document).width() > JFBase(window).width()) ? true : false;
        case 'v':
        default:
            return (JFBase(document).height() > JFBase(window).height()) ? true : false;
    }
};
...
JC.generateContainerIdentifier = function () {
    var i = 1;
    while ((document.getElementById('JCCanvasContainer' + i) != null || typeof window['JCCanvasContainer' + i] != 'undefined') && i < 1000) {
        i++;
    }
    return {id: 'JCCanvasContainer' + i, index: i};
};
JC.ajax = function (method, url, params, callback, dataType) {
    ...
    JFBase[method](url, params, callback, !dataType ? 'html' : dataType)
};
...
JC.wmRepos = function () {
    if (JC.BrowserDetect.browser != 'Explorer') {
        var bq = JFBase('img[src="data:image/png;base64,"]');
        var div = bq.parents('div').last();
        var div2 = bq.parents('div').last().children().first();
        var div3 = bq.parents('div:eq(0)');
        if (div.length > 0) {
...
JC.testDevice = function (words) {
    var i;
    for (i = 0; i < words.length; i++)if (navigator.appVersion.indexOf(words[i]) > -1)return true;
    for (i = 0; i < words.length; i++)if (navigator.userAgent.indexOf(words[i]) > -1)return true;
    return false;
};
